...
export default function EditCar({ car }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('admin.update', car.id), formData, {
            forceFormData: true,
            onSuccess: () => {
    ...
    return (
        <div className='p-4'>
            ...
            <motion.div
                ...
                className="w-full p-6 bg-gray-100 border-4 border-gray-400 dark:shadow-gray-900 hover:shadow-black hover:border-black dark:border-gray-600 dark:bg-gray-900 shadow-xl shadow-gray-500 rounded-xl mt-10 hover:dark:border-white/50 hover:dark:shadow-white/10"
            >
                <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-8">
                    Update Car in Your Fleet
                </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                        <div className="relative">
                            <input
                                ...
                                required
                                className="w-full px-4 py-3 border-2 border-gray-400 focus:border-black dark:border-gray-700 rounded-lg outline-none dark:bg-gray-800 dark:text-white focus:dark:border-white/50"
                            />
                            <label
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                        <div className="relative">
                            <select
                                ...
                                className="w-full px-4 py-3 border-2 border-gray-400 dark:border-gray-700 rounded-lg focus:border-black outline-none dark:bg-gray-800 dark:text-white focus:dark:border-white/50"
                            >
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full px-4 py-3 border-2 border-gray-400 dark:border-gray-700 focus:border-black rounded-lg outline-none dark:bg-gray-800 dark:text-white focus:dark:border-white/50"
                            >
