...
import {
    Calendar, Phone, Clock, DollarSign, CheckCircle,
    XCircle, AlertCircle, User, Mail, Zap, BadgeCheck,
    Search, ArrowUp , Filter
} from 'lucide-react';
        ...
        <ManagerLayout>
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-8 max-w-7xl mx-auto">
                ...
                <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    {/* Filter Dropdown with Animated Transition */}
                    <motion.div
                    ...
                    >
                        ...
                        <select
                            ...
                            className="w-full pl-10 px-4 py-3 border-2 border-gray-400 rounded-md shadow-sm outline-none hover:border-black focus:border-black dark:bg-gray-900 dark:text-white dark:border-gray-700 hover:dark:border-white/50 focus:dark:border-white/50"
                        >
